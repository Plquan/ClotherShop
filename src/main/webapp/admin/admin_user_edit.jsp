                            ...
                            <h3 style="color: red; text-align: center; margin: 20px 0">${requestScope.error}</h3>
                                <form action="EditUserServlet" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="username" value="${username}"  class="form-control" required autofocus placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select required class="form-control" name="permission">    
                                             <option  value="False">Hủy bỏ</option>                                                                                           
                                              <option ${roleId == 1 ? 'selected' : ''} value="True">Cho phép</option>
