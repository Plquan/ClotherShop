			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
					  ...
					  <li> <a href="ManageUserServlet"><i class="fas fa-user"></i> <span>Quản lí người dùng</span></a> </li>
			
						<li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Quản lí sản phẩm </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								<li><a href="ManageCategoryServlet">Danh sách danh mục</a></li>
								<li><a href="edit-room.html"> Danh sách sản phẩm </a></li>
							</ul>
						</li>
